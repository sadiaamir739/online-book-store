...
<head>
    ...
    <title>Add New Book | Online Book Store</title>
...
<body>
    ...
    <main class="page-container">
        <header class="page-header">
            <div class="page-icon"><i class="bi bi-book-half"></i></div>
            <h1>Add New Book</h1>
            <p>Add a book to your online store collection.</p>
        </header>
        ...
        <div class="form-card">
            ...
            <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="title" type="text" name="title" value="{{ old('title') }}" placeholder="Enter book title" required>
                    @error('title') <div class="field-error">{{ $message }}</div> @enderror
                </div>

                <div class="form-group">
                    <label for="author"><i class="bi bi-person"></i> Author</label>
                    <input id="author" type="text" name="author" value="{{ old('author') }}" placeholder="Enter author name" required>
                ...
                <div class="form-group">
                    ...
                    <input id="price" type="number" name="price" step="0.01" value="{{ old('price') }}" placeholder="0.00" required>
                    @error('price') <div class="field-error">{{ $message }}</div> @enderror
                </div>

                <div class="form-group">
                    <label for="description"><i class="bi bi-card-text"></i> Description</label>
                    <textarea id="description" name="description" placeholder="Enter a short description">{{ old('description') }}</textarea>
                    @error('description') <div class="field-error">{{ $message }}</div> @enderror
                </div>

                <div class="form-group">
                    <label for="cover_image"><i class="bi bi-image"></i> Cover Image</label>
